//no include guard, if this is included twice you have included it somewhere it does not belong.
//removed from public view, access via the objects initialized from them
