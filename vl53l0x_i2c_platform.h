...
class ArduinoWirer {
public:
  ArduinoWirer(TwoWire &i2c, uint8_t deviceAddress);
...
// initialize I2C
  void i2c_init(unsigned kHz = 400);
...
public: //until a friend declaration is added for the one class that needs access
  TwoWire &i2c;
